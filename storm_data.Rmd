...
==========================================
Created by Aman Sinha  06/11/2015
...
```{r}
setwd("C:/Users/Aman/Desktop/Rprog/rrsrch/RepData_PeerAssessment2/")
...
if (!"repdata-data-StormData.csv.bz2" %in% dir("./data/")) {
    ...
    bunzip2("data/repdata-data-StormData.csv.bz2", overwrite=T, remove=F)
}
...
```{r}
if (!"stormData" %in% ls()) {
    stormData <- read.csv("data/repdata-data-StormData.csv", sep = ",")
}
dim(stormData)
head(stormData, n = 2)
```
